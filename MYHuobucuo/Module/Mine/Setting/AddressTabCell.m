...
- (void)initUI
{
    ...
    [nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.mas_left).offset(fScreen(30));
        make.top.equalTo(self.mas_top).offset(fScreen(30));
        make.right.equalTo(self.mas_right).offset(-fScreen(118 + phoneSize.width + 2));
    ...
    [phoneLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.mas_right).offset(-fScreen(118));
    ...
    [defaultButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.mas_left).offset(fScreen(30) + 1);
